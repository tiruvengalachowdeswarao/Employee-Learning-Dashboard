...
class App extends React.Component {
  ...
  render() {
    ...
    let employeeCourseDetailsTableBody = this.state.data.map((obj, index) => {
      return (
        <tr
          key={index}
          onClick={() => {
            this.coursedetails(obj.CourseName);
          }}
        >
          <td key={index}>{index + 1}</td>
          <td key={index}>{obj.EmployeeID}</td>
    ...
    if (this.state.displayCoursedetails) {
      employeeCourseDetails = this.state.selectedEmployeeLearnings.map(
        (obj, index) => {
          return (
            <tr key={index}>
              <td key={index}>{index + 1}</td>
    ...
    let employeeComplianceDetailsTableBody = this.state.compliance.map(
      (obj, index) => {
        return (
          <tr key={index}>
            <td key={index}>{index + 1}</td>
    ...
    let employeeNonComplianceDetailsTableBody = this.state.noncompliance.map(
      (obj, index) => {
        return (
          <tr key={index}>
            <td key={index}>{index + 1}</td>
        ...
        <Tab.Container defaultActiveKey="home">
          <Row>
            ...
            <Col md={9} className="Body">
                    ...
                    <Form onSubmit={this.onSubmit}>
                      <Row className="justify-content-md-center">
                        <Col md="6">
                          ...
                          <Modal
                            show={this.state.setShowFileUploadSuccessMessage}
                            onHide={this.hideFileUploadSuccessMessage}
                            centered
                            style={{ textAlign: "center", color: "green" }}
                          >
                            <Modal.Body>
                              File Uploaded Successfully.<br></br>
                              Click on <b>Generate Dashboard</b> button to
                              generate the dashboard.
                            </Modal.Body>
                            <Modal.Footer>
                              <Button
                                variant="success"
                                onClick={this.hideFileUploadSuccessMessage}
                              >
                                Close
                              </Button>
                            </Modal.Footer>
                          ...
                          <Modal
                            show={this.state.setShowFileUploadErrorMessage}
                            onHide={this.hideFileUploadErrorMessage}
                            centered
                          ...
                          >
                            ...
                            <Modal.Footer>
                              <Button
                                variant="danger"
                                onClick={this.hideFileUploadErrorMessage}
                              >
                                Close
                              </Button>
                            </Modal.Footer>
                        ...
                        <Col xs="4">
                          <Card style={{ width: "20rem" }} bg="light">
                            ...
                            <Card.Body>
                              ...
                              <Button
                                variant="link"
                                onClick={this.viewEmployeeDetails}
                              >
                          ...
                          <Modal
                            show={this.state.setShowViewEmployeeDetails}
                            onHide={this.hideViewEmployeeDetails}
                            centered
                          >
                            ...
                            <Modal.Body>
                              <div className="ModalTable">
                                <Table bordered hover style={{ margin: "0px" }}>
                                  ...
                                  <tbody>{employeeDetailsTableBody}</tbody>
                                </Table>
                              </div>
                            </Modal.Body>
                            <Modal.Footer>
                              <Button
                                variant="secondary"
                                onClick={this.hideViewEmployeeDetails}
                              >
                                Close
                              </Button>
                            </Modal.Footer>
                        ...
                        <Col xs="4">
                          <Card style={{ width: "20rem" }} bg="light">
                            ...
                            <Card.Body>
                              ...
                              <Button
                                variant="link"
                                onClick={this.ViewEmployeeComplianceDetails}
                              >
                                View Details
                              </Button>
                            </Card.Body>
                          ...
                          <Modal
                            ...
                            onHide={this.hideEmployeeComplianceDetails}
                            centered
                          >
                            <Modal.Header closeButton>
                              <Modal.Title>
                                Security complaint Employees
                              </Modal.Title>
                            </Modal.Header>
                            <Modal.Body>
                              <div className="ModalTable">
                                <Table bordered hover style={{ margin: "0px" }}>
                                  ...
                                  <tbody>
                                    {employeeComplianceDetailsTableBody}
                                  </tbody>
                                </Table>
                              </div>
                            </Modal.Body>
                            <Modal.Footer>
                              <Button
                                variant="secondary"
                                onClick={this.hideEmployeeComplianceDetails}
                              >
                                Close
                              </Button>
                            </Modal.Footer>
                        ...
                        <Col xs="4">
                          <Card style={{ width: "100%" }} bg="light">
                            ...
                            <Card.Body>
                              ...
                              <Button
                                variant="link"
                                onClick={this.ViewEmployeeNonComplianceDetails}
                              >
                                View Details
                              </Button>
                            </Card.Body>
                          ...
                          <Modal
                            ...
                            onHide={this.hideEmployeeNonComplianceDetails}
                            centered
                          >
                            <Modal.Header closeButton>
                              <Modal.Title>
                                Security Non-complaint Employees
                              </Modal.Title>
                            </Modal.Header>
                            <Modal.Body>
                              <div className="ModalTable">
                                <Table bordered hover style={{ margin: "0px" }}>
                                  ...
                                  <tbody>
                                    {employeeNonComplianceDetailsTableBody}
                                  </tbody>
                                </Table>
                              </div>
                            </Modal.Body>
                            <Modal.Footer>
                              <Button
                                variant="secondary"
                                onClick={this.hideEmployeeNonComplianceDetails}
                              >
                                Close
                              </Button>
                            </Modal.Footer>
              ...
              <Modal
                show={this.state.displayCoursedetails}
                onHide={this.hideEmployeeCourseDetails}
                centered
              >
                <Modal.Header closeButton>
                ...
                <Modal.Footer>
                  <Button
                    variant="secondary"
                    onClick={this.hideEmployeeCourseDetails}
                  >
                    Close
                  </Button>
                </Modal.Footer>
